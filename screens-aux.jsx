// screens-aux.jsx — Onboarding, Saved, Profile screens
// Exports: OnboardingScreen, SavedScreen, ProfileScreen
...
function OnboardingScreen({ onComplete }) {
  ...
  const steps = [
    ...
    () => React.createElement('div', {
      ...
      React.createElement('h1', {
        style: {
          ...
          fontFamily: t.font.heading, margin: 0, letterSpacing: '-0.8px',
          lineHeight: 1.2,
        },
      }, 'Find your next meal at the right price'),
      React.createElement('p', {
        style: {
          fontSize: 15, color: t.textSecondary, fontFamily: t.font.body,
    ...
    () => React.createElement('div', {
      ...
      React.createElement('p', {
        style: {
          fontSize: 14, color: t.textSecondary, fontFamily: t.font.body,
    ...
    () => React.createElement('div', {
      ...
      React.createElement('div', {
        ...
        React.createElement('div', {
          style: {
            fontSize: 48, fontWeight: 900, color: t.primary,
            fontFamily: t.font.heading, textAlign: 'center',
            letterSpacing: '-2px', marginBottom: 20,
          },
        }, `$${budgetPref}`),
        React.createElement(BudgetSlider, {
          value: budgetPref, onChange: setBudgetPref, max: 50,
        }),
        React.createElement('div', {
          style: {
        ...
        [
          ...
          return React.createElement('button', {
            ...
            React.createElement('div', { style: { flex: 1 } },
              ...
              React.createElement('div', {
                style: { fontSize: 12, color: t.textSecondary, fontFamily: t.font.body, marginTop: 1 },
              }, d.desc)
            ),
            isActive && React.createElement('svg', {
              width: 20, height: 20, viewBox: '0 0 24 24', fill: t.primary,
            },
  ...
  return React.createElement('div', {
    style: {
      display: 'flex', flexDirection: 'column', height: '100%', background: t.bg,
    },
  },
    // Progress dots
    React.createElement('div', {
    ...
    // Bottom buttons
    React.createElement('div', {
      style: { padding: '16px 24px 24px', display: 'flex', gap: 12 },
    },
      step > 0 && React.createElement('button', {
        onClick: () => setStep(s => s - 1),
        style: {
          padding: '14px 20px', background: t.surfaceAlt,
      ...
      React.createElement('button', {
        ...
        style: {
          flex: 1, padding: '14px', background: t.primary,
...
function SavedScreen() {
  ...
  const savedPlaces = PLACES.slice(0, 4);
  ...
  return React.createElement('div', {
    ...
    React.createElement('div', {
      ...
      activeTab === 'favorites' && React.createElement('div', {
        style: { display: 'flex', flexDirection: 'column', gap: 10 },
      },
        savedPlaces.map(place =>
          React.createElement(PlaceCard, { key: place.id, place, variant: 'standard' })
        )
      ),
      activeTab === 'searches' && React.createElement('div', {
        ...
        [
          ...
          React.createElement('div', {
            ...
            React.createElement('div', null,
              React.createElement('div', {
                style: { fontSize: 14, fontWeight: 600, color: t.text, fontFamily: t.font.body },
              }, s.query),
              React.createElement('div', {
                style: { fontSize: 12, color: t.textTertiary, fontFamily: t.font.body, marginTop: 2 },
              }, `${s.results} results`)
            ),
      ...
      activeTab === 'recent' && React.createElement('div', {
        style: { display: 'flex', flexDirection: 'column', gap: 10 },
      },
...
function ProfileScreen() {
  ...
  return React.createElement('div', {
    ...
    // Header
    React.createElement('div', {
      style: { padding: '24px 16px 20px', textAlign: 'center' },
    },
      React.createElement('div', {
        style: {
      ...
      React.createElement('div', {
        style: { fontSize: 13, color: t.textTertiary, fontFamily: t.font.body, marginTop: 4 },
      }, 'Free Plan · 23 saves'),
    ),
    ...
    React.createElement('div', {
      ...
      React.createElement('div', {
        style: { fontSize: 16, fontWeight: 800, fontFamily: t.font.heading, letterSpacing: '-0.3px' },
      }, 'Upgrade to Pro'),
      React.createElement('div', {
        style: { fontSize: 12, fontFamily: t.font.body, marginTop: 4, opacity: 0.85, lineHeight: 1.4 },
      ...
      React.createElement('button', {
        style: {
          ...
          fontWeight: 700, fontFamily: t.font.heading, cursor: 'pointer',
    ...
    // Menu items
    React.createElement('div', {
      style: { padding: '0 16px', display: 'flex', flexDirection: 'column', gap: 2 },
    },
      menuItems.map((item, i) =>
        React.createElement('button', {
          ...
          style: {
            display: 'flex', alignItems: 'center', gap: 14,
            padding: '14px 16px', background: t.surface,
            border: 'none', borderRadius: i === 0 ? '14px 14px 2px 2px' :
              i === menuItems.length - 1 ? '2px 2px 14px 14px' : '2px',
            cursor: 'pointer', textAlign: 'left',
            borderBottom: i < menuItems.length - 1 ? `1px solid ${t.border}` : 'none',
          },
        },
          React.createElement('svg', {
            width: 20, height: 20, viewBox: '0 0 24 24', fill: t.textSecondary,
          },
          ...
          React.createElement('svg', {
            width: 16, height: 16, viewBox: '0 0 24 24', fill: t.textTertiary,
          },
            React.createElement('path', { d: 'M8.59 16.59L13.17 12 8.59 7.41 10 6l6 6-6 6z' })
          )
        )
    ...
    React.createElement('div', {
      style: {
        ...
        fontSize: 11, color: t.textTertiary, fontFamily: t.font.body,
        marginTop: 'auto',
      },
...
Object.assign(window, { OnboardingScreen, SavedScreen, ProfileScreen });
